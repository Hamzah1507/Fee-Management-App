...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  Future<void> _register() async {
    ...
    if (name.isEmpty || email.isEmpty || password.isEmpty || confirm.isEmpty) {
      _showSnack('Please fill all fields', isError: true); return;
    }
    if (password != confirm) {
                  ...
                  child: Column(
                    children: [
                      ...
                      const Text('Create Account',
                          style: TextStyle(color: Colors.white, fontSize: 24, fontWeight: FontWeight.w800, letterSpacing: -.5)),
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const Text('Join GLS Fees Manager',
                          style: TextStyle(fontSize: 20, fontWeight: FontWeight.w800, color: _primary, letterSpacing: -.4)),
                      const SizedBox(height: 4),
                      ...
                      _inputField(controller: _nameController, label: 'Full Name',
                          icon: Icons.person_outline_rounded, capitalization: TextCapitalization.words),
                      const SizedBox(height: 12),
                      _inputField(controller: _emailController, label: 'Email Address',
                          icon: Icons.email_outlined, keyboardType: TextInputType.emailAddress),
                      const SizedBox(height: 12),
                      _inputField(
                        controller: _passwordController, label: 'Password', icon: Icons.lock_outline_rounded,
                        obscure: _obscure,
                      ...
                      const SizedBox(height: 12),
                      _inputField(
                        controller: _confirmController, label: 'Confirm Password', icon: Icons.lock_outline_rounded,
                      ...
                      Row(
                        ...
                        children: [
                          const Text('Already have an account? ', style: TextStyle(color: _textSub, fontSize: 13.5)),
                          GestureDetector(
