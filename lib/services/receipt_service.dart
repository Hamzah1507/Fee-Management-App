...
class ReceiptService {
  ...
  static Future<Uint8List> _buildPdf({
    ...
    final receiptNo = 'GLS/${DateTime.now().year}/${payment.id.substring(0, 8).toUpperCase()}';
                  ...
                  child: pw.Column(
                    ...
                    children: [
                      ...
                      pw.Row(
                        ...
                        children: [
                          _infoChip('Date',
                              _formatDate(payment.createdAt), textSub),
                          _infoChip('Semester',
                              'Semester ${payment.semester}', navyBlue),
                          _infoChip('Method',
                              methodIcon, textDark),
                        ],
                      ),
                      ...
                      pw.Container(
                        ...
                        child: pw.Column(
                          children: [
                            ...
                            _detailRow('Course / Program',
                                student.course, textDark, textSub),
                            pw.SizedBox(height: 10),
                            _detailRow('Student ID',
                                student.id.substring(0, 10).toUpperCase(),
                                textDark, textSub),
                            pw.SizedBox(height: 10),
                            _detailRow('Academic Year',
                                _academicYear(), textDark, textSub),
                          ],
                        ),
                      ),
                      ...
                      pw.Container(
                        ...
                        child: pw.Column(
                          children: [
                            _detailRow('Total Course Fees',
                                'Rs. ${student.totalFees}',
                                textDark, textSub),
                            pw.SizedBox(height: 8),
                            _detailRow('Total Paid (till date)',
                                'Rs. ${student.paidFees}',
                                greenColor, textSub),
                            pw.SizedBox(height: 8),
                            pw.Divider(color: PdfColors.grey300),
                            pw.SizedBox(height: 8),
                            _detailRow('Balance Pending',
        ...
        build: (context) {
          return pw.Column(
            children: [
                      ...
                      children: [
                        pw.Text('FEE STATEMENT',
                            style: pw.TextStyle(
                                ...
                                letterSpacing: 2)),
                        pw.SizedBox(height: 4),
                        pw.Text('Semester-wise Breakdown',
                            style: const pw.TextStyle(
                                color: PdfColors.white,
                                fontSize: 10)),
                      ],
              ...
              pw.Container(
                  width: double.infinity, height: 4, color: goldColor),
                ...
                child: pw.Container(
                  ...
                  child: pw.Column(
                    ...
                    children: [
                      ...
                      pw.SizedBox(height: 20),
                      pw.Text('SEMESTER-WISE PAYMENT HISTORY',
                          style: pw.TextStyle(
                              fontSize: 10,
                              fontWeight: pw.FontWeight.bold,
                              color: textSub,
                      ...
                      pw.Row(
                        children: [
                          pw.Expanded(
                              child: _summaryBox('Total Fees',
                                  'Rs. ${student.totalFees}',
                                  textSub, lightGrey)),
                          pw.SizedBox(width: 12),
                          pw.Expanded(
                              child: _summaryBox('Total Paid',
                                  'Rs. ${student.paidFees}',
                                  greenColor, lightGrey)),
                          pw.SizedBox(width: 12),
                          pw.Expanded(
                              child: _summaryBox(
                                  'Pending',
  ...
  static Future<pw.ImageProvider?> _loadLogo() async {
    try {
      final bytes =
          await rootBundle.load('assets/images/gls_logo.png');
  ...
  static pw.Widget _infoChip(
    ...
    return pw.Column(
      ...
      children: [
        pw.Text(label,
            style: const pw.TextStyle(
                color: PdfColor.fromInt(0xFF8A94A6), fontSize: 9)),
  ...
  static pw.Widget _detailRow(
      ...
      PdfColor labelColor, {bool bold = false}) {
    return pw.Row(
      mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
      children: [
        pw.Text(label,
            style:
                pw.TextStyle(color: labelColor, fontSize: 10)),
        pw.Text(value,
            style: pw.TextStyle(
                color: valueColor,
                fontSize: 10,
  ...
  static pw.Widget _tableCell(String text) {
    return pw.Padding(
      ...
      child: pw.Text(text,
          style: const pw.TextStyle(
              color: PdfColor.fromInt(0xFF1A1F36), fontSize: 10)),
    );
  }

  static pw.Widget _tableBoldCell(String text,
